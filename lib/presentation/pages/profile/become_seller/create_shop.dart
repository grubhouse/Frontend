                                  ...
                                  Padding(
                                    ...
                                    child: CustomButton(
                                      ...
                                      onPressed: () {
                                       ...
                                       descName.text.isEmpty ||
                                       phoneName.text.isEmpty ||
                                       tax.text.isEmpty ||
                                       deliveryTimeFrom.text.isEmpty ||
                                       deliveryTimeTo.text.isEmpty ||
                                       startPrice.text.isEmpty ||
                                       pricePerKm.text.isEmpty ||
                                       data == null) { // Ensuring all fields are filled
                                       ScaffoldMessenger.of(context).showSnackBar(
                                       ...
                                       return;
                                        ...
                                        /*}else{
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(content: Text("Must Fill All Fields")),
                                          );
                                        }*/
                                      },
                                    ),
